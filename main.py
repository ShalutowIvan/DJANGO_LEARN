...
# w = Home.objects.values('title', 'cat__name') - это один sql запрос, объединяет сам таблицы и делает запросы с двух таблиц. То есть джанго делает sql запросы оптимизировано. Самому такое писать сложнее. 
# 42 мин ост
