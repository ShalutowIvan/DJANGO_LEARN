...
#Перейдем в консоль джанго. Сделаем запрос всех полей Home.objects.all(). БУдет возвращен список, к нему можно применять срезы. Срезы идут на уровне sql запроса, а не питона
