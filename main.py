...
# чтобы прописать ссылку нужно в шаблоне html написать ссылку на страницу, например:
# <li class="logo"><a href="/"><div class="logo"></div></a></li>
# но лучше прописывать имя шаблона из файла urls.py в папке с нашим приложением
#у нас там уже шаблон прописан, им воспользуемся. Пропишем ы html это:
